 ...
 */
@Internal
public final class ProtoMessageRuntimeHelper extends RuntimeHelper {

  private final ProtoAdapter protoAdapter;

  @Internal
  public static ProtoMessageRuntimeHelper create(DynamicProto dynamicProto, CelOptions celOptions) {
    return new ProtoMessageRuntimeHelper(
  ...
  private ProtoMessageRuntimeHelper(ProtoAdapter protoAdapter) {
