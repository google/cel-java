...
import static dev.cel.common.Operator.LESS;
...
public final class LessOperator extends CelStandardFunction {
  private static final LessOperator ALL_OVERLOADS = create(LessOverload.values());
