...
final class LiteRuntimeImpl implements CelLiteRuntime {
  ...
  static final class Builder implements CelLiteRuntimeBuilder {
    ...
    public CelLiteRuntime build() {
      ...
      return new LiteRuntimeImpl(interpreter, this);
    }
    ...
    private Builder(Builder builder) {
      ...
      this.celStandardFunctions = builder.celStandardFunctions;
  ...
  private LiteRuntimeImpl(Interpreter interpreter, Builder runtimeBuilder) {
