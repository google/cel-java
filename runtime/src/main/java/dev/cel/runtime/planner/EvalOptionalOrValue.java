...
final class EvalOptionalOrValue extends PlannedInterpretable {
  ...
  public Object eval(GlobalResolver resolver, ExecutionFrame frame) throws CelEvaluationException {
    ...
    if (!(lhsValue instanceof Optional)) {
      throw new IllegalArgumentException("expected optional value, found: " + lhsValue);
    }
  ...
  static EvalOptionalOrValue create(long exprId, PlannedInterpretable lhs, PlannedInterpretable rhs) {
    return new EvalOptionalOrValue(exprId, lhs, rhs);
  }

  private EvalOptionalOrValue(long exprId, PlannedInterpretable lhs, PlannedInterpretable rhs) {
    super(exprId);
