...
@ThreadSafe
@Internal
public final class LegacyDispatcher implements Dispatcher, Registrar {
  public static LegacyDispatcher create() {
  ...
  public synchronized Optional<ResolvedOverload> findOverload(
    ...
    return LegacyDispatcher.findOverload(functionName, overloadIds, overloads, args);
  }
  ...
  abstract static class ResolvedOverloadImpl implements ResolvedOverload {
    ...
    static ResolvedOverload of(
      ...
      return new AutoValue_LegacyDispatcher_ResolvedOverloadImpl(
