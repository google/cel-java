...
public abstract class PartialVars {
  ...
  public static PartialVars of(
      CelVariableResolver resolver, Iterable<CelAttributePattern> unknownAttributes) {
   ...
   * CelAttributePattern}s.
   */
  public static PartialVars of(Map<String, ?> variables, CelAttributePattern... unknownAttributes) {
    return of(
