...
public abstract class CelValueDispatcher {
  ...
  public abstract static class Builder {
    ...
    public Builder addOverload(CelFunctionBinding functionBinding) {
      overloadsBuilder().put(functionBinding.getOverloadId(), functionBinding);
      return this;
    }

    @CanIgnoreReturnValue
    public Builder addDynamicDispatchOverload(String functionName, CelFunctionOverload definition) {
      overloadsBuilder()
          .put(functionName, CelFunctionBinding.from(functionName, ImmutableList.of(), definition));
