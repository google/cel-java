...
import dev.cel.protobuf.CelLiteDescriptor.FieldDescriptor.ValueType;
...
final class ProtoDescriptorCollector {
  ...
  @VisibleForTesting
  ImmutableList<MessageDescriptor> collectMessageInfo(FileDescriptor targetFileDescriptor) {
    ImmutableList.Builder<MessageDescriptor> messageInfoListBuilder = ImmutableList.builder();
  ...
  ProtoDescriptorCollector() {
    this(DebugPrinter.newInstance(false));
  }
