...
public final class DefaultDescriptorPool implements CelDescriptorPool {
  ...
  private static final ImmutableMap<WellKnownProto, Descriptor> WELL_KNOWN_PROTO_TO_DESCRIPTORS =
      ImmutableMap.<WellKnownProto, Descriptor>builder()
          ...
          .put(WellKnownProto.DURATION_VALUE, Duration.getDescriptor())
          ...
          .put(WellKnownProto.TIMESTAMP_VALUE, Timestamp.getDescriptor())
          ...
          .put(WellKnownProto.EMPTY_VALUE, Empty.getDescriptor())
          .put(WellKnownProto.FIELD_MASK_VALUE, FieldMask.getDescriptor())
          .buildOrThrow();
