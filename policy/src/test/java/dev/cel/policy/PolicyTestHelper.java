...
final class PolicyTestHelper {
  ...
  enum TestYamlPolicy {
    NESTED_RULE(
        "nested_rule", true, "cel.bind(variables.permitted_regions, [\"us\", \"uk\", \"es\"],"
    ...
    RESTRICTED_DESTINATIONS("restricted_destinations", false, "cel.bind(variables.matches_origin_ip,"
