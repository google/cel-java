...
final class TypeProviderLegacyImpl implements CelTypeProvider {
  ...
  public Optional<CelType> findType(String typeName) {
    return typeProvider.lookupCelType(typeName);
  }

  // @Override
  // public Optional<CelType> lookupCelType(String typeName) {
  //   return typeProvider.findType(typeName).map(TypeType::create);
  // }
  //
  // @Override
  ...
  //       (StructType)
  //           typeProvider.findType(messageType).filter(t -> t instanceof StructType).orElse(null);
  //   if (structType == null) {
  //     return null;
  //   }
  //
