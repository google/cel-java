...
public final class CelCheckerLegacyImpl implements CelChecker, EnvVisitable {
  ...
  public static final class Builder implements CelCheckerBuilder {
    ...
    private String deprecatedContainerString;
    ...
    public CelCheckerBuilder setContainer(String container) {
      ...
      this.deprecatedContainerString = container;
      return this;
    }
    ...
    public CelCheckerLegacyImpl build() {
      ...
      if (!deprecatedContainerString.isEmpty() && !container.name().isEmpty()) {
        throw new IllegalArgumentException(
            "Both container and celContainer cannot be set. Container: "
                + deprecatedContainerString
                + ",celContainer: "
                + container);
      }
      if (!deprecatedContainerString.isEmpty()) {
        // Compatibility only. Will be removed.
        container = CelContainer.ofName(deprecatedContainerString);
      }
    ...
    private Builder() {
      ...
      this.deprecatedContainerString = "";
    }
  }
