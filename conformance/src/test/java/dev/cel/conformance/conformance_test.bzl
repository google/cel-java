...
def conformance_test(name, data, dashboard, skip_tests = []):
    if dashboard:
        java_test(
            ...
            runtime_deps = ["//third_party/java/cel/conformance/src/test/java/dev/cel/conformance:run"],
            tags = [
                "manual",
                "notap",
            ],
        ...
        native.sh_test(
            name = name,
            size = "small",
            srcs = ["//third_party/java/cel/conformance/src/test/java/dev/cel/conformance:conformance_test.sh"],
