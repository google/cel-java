...
public class RuntimeArtifactTest {
  ...
  private static final String CHECKED_EXPR = "reference_map {\n"
      + "  key: 2\n"
      + "  value {\n"
  ...
  public void eval() throws Exception {
    CelRuntime runtime = CelRuntimeFactory.standardCelRuntimeBuilder()
        ...
        .addFunctionBindings(CelFunctionBinding.fromOverloads(
            "getThree",
  ...
  public void eval_error() throws Exception {
    ...
    CelEvaluationException e = assertThrows(CelEvaluationException.class, () -> runtime.createProgram(ast).eval());
    assertThat(e).hasMessageThat().contains("cannot resolve 'cel.expr.conformance.proto3.TestAllTypes' as a message");
    assertThat(e.getCause()).isInstanceOf(CelAttributeNotFoundException.class);
  }
}
