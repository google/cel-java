...
public class RegexLiteralValidatorTest {
  ...
  public void regex_validFormat(String source) throws Exception {
  ...
  @Test
  public void regex_withVariable_noOp() throws Exception {
  ...
  @Test
  public void regex_withFunction_noOp() throws Exception {
    Cel cel =
  ...
  @Test
  public void regex_invalidFormat() throws Exception {
    CelAbstractSyntaxTree ast = CEL.compile("'test'.matches('**')").getAst();
