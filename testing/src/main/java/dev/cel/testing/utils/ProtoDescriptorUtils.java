...
public final class ProtoDescriptorUtils {
   ...
   */
  public static CelDescriptors getAllDescriptors() throws IOException {
  ...
  /**
   * Returns the default instance of the given descriptor.
   *
   * @param descriptor The descriptor to get the default instance for.
   * @return The default instance of the given descriptor.
   * @throws IOException If there is an error during the loading process.
   */
  public static Message getDefaultInstance(Descriptor descriptor) throws IOException {
