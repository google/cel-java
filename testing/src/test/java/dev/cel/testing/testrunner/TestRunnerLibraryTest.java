...
public class TestRunnerLibraryTest {
  ...
  @Before
  public void setUp() {
    System.setProperty("is_raw_expr", "True");
  }

  @Test
  public void run_experiment() throws Exception {
    String expr = "proto.getExt(spec, cel.expr.conformance.proto2.int32_ext) > 0";
    System.out.println("expr: " + expr);
    System.setProperty(
        "file_descriptor_set_path",
        "third_party/java/cel/testing/src/test/java/dev/cel/testing/testrunner/test_all_types_fds.pb");
    System.setProperty(
        "config_path",
        "third_party/java/cel/testing/src/test/resources/policy/custom_variable_bindings/config.yaml");

    // String fdsContent =
    //
    // Resources.toString(Resources.getResource(Ascii.toLowerCase("dev/cel/testing/testrunner/test_all_types_fds.pb")), UTF_8);
    // System.out.println("fds: " + fdsContent);
    ...
    CelExprFileSource celExprFileSource = CelExprFileSource.fromFile(expr);
    ...
    TestRunnerLibrary.evaluateTestCase(simpleOutputTestCase, celTestContext, celExprFileSource);
  }
