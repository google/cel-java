...
public class JUnitXmlReporterTest {
  ...
  public void testGenerateReport_coverageReport_noCoverage() throws IOException {
    ...
    CelCoverageIndex.CoverageReport coverageReport = new CelCoverageIndex.CoverageReport();
    coverageReport.nodes = 0L;
    coverageReport.coveredNodes = 0L;
    coverageReport.branches = 0L;
    coverageReport.coveredBooleanOutcomes = 0L;
  ...
  public void testGenerateReport_coverageReport_withCoverage() throws IOException {
    ...
    CelCoverageIndex.CoverageReport coverageReport = new CelCoverageIndex.CoverageReport();
    coverageReport.nodes = 10L;
    coverageReport.coveredNodes = 10L;
    coverageReport.branches = 10L;
    coverageReport.coveredBooleanOutcomes = 5L;
    coverageReport.unencounteredNodes.add("Node 1");
    coverageReport.unencounteredNodes.add("Node 2");
    coverageReport.unencounteredBranches.add("Branch 1");
    coverageReport.unencounteredBranches.add("Branch 2");
    coverageReport.graphUrl = "http://graphviz/url";
