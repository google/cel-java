...
import static dev.cel.optimizer.AstMutator.newInstance;
...
public class AstMutatorTest {
  ...
  public void replaceSubtree_replaceConst() throws Exception {
    ...
    MutableAst result = MUTABLE_AST.replaceSubtree(mutableAst, newBooleanConst, mutableAst.mutableExpr().id());
  ...
  public void astMutator_nonMacro_sourceCleared() throws Exception {
    ...
    CelAbstractSyntaxTree mutatedAst =
        MUTABLE_AST.replaceSubtree(mutableAst, newBooleanConst, mutableAst.mutableExpr().id()).toParsedAst();
  ...
  public void astMutator_macro_sourceMacroCallsPopulated() throws Exception {
    ...
    CelAbstractSyntaxTree mutatedAst = MUTABLE_AST.replaceSubtree(mutableAst, newBooleanConst, 1).toParsedAst(); // no_op
  ...
  public void replaceSubtreeWithNewAst_astsContainTaggedExtension_retained() throws Exception {
    ...
    MutableAst mutableAst2 = MutableAst.fromCelAst(astToReplaceWith);
  ...
  public void replaceSubtree_rootReplacedWithMacro_macroCallPopulated(
    ...
    CelAbstractSyntaxTree mutatedAst =
        MUTABLE_AST.replaceSubtree(
            mutableAst, mutableAst2, mutableAst.mutableExpr().id()).toParsedAst();
  ...
  public void replaceSubtree_leftBranchReplacedWithMacro_macroCallPopulated() throws Exception {
    ...
    CelAbstractSyntaxTree mutatedAst =
        MUTABLE_AST.replaceSubtree(mutableAst, mutableAst2, 3).toParsedAst(); // Replace false with the macro expr
  ...
  public void replaceSubtree_rightBranchReplacedWithMacro_macroCallPopulated() throws Exception {
    ...
    CelAbstractSyntaxTree mutatedAst =
        MUTABLE_AST.replaceSubtree(mutableAst, mutableAst2, 1).toParsedAst(); // Replace true with the macro expr
  ...
  public void replaceSubtreeWithNewBindMacro_replaceRoot() throws Exception {
    ...
    CelAbstractSyntaxTree mutatedAst =
        MUTABLE_AST.replaceSubtreeWithNewBindMacro(
            mutableAst,
            variableName,
            MutableExpr.ofConstant(CelConstant.ofValue(3L)),
            resultExpr,
            mutableAst.mutableExpr().id(), true).toParsedAst();
  ...
  public void replaceSubtreeWithNewBindMacro_nestedBindMacro_replaceComprehensionResult()
    ...
    mutableAst =
        MUTABLE_AST.replaceSubtreeWithNewBindMacro(
            mutableAst,
            nestedVariableName,
            MutableExpr.ofConstant(CelConstant.ofValue(1L)),
            resultExpr,
  ...
  public void replaceSubtree_macroReplacedWithConstExpr_macroCallCleared() throws Exception {
    ...
    CelAbstractSyntaxTree mutatedAst = MUTABLE_AST.replaceSubtree(mutableAst, mutableAst2, mutableAst.mutableExpr().id()).toParsedAst();
  ...
  public void replaceSubtree_replaceExtraneousListCreatedByMacro_unparseSuccess() throws Exception {
    ...
    MutableAst mutableAst = MutableAst.fromCelAst(ast);
    MutableAst mutableAst2 = MutableAst.fromCelAst(ast);
        ...
        MUTABLE_AST.replaceSubtree(
            ...
            MutableExpr.ofCreateList(
                MutableCreateList.create(
                    MutableExpr.ofConstant(CelConstant.ofValue(2L))
                )
            ),
            9L
        ).toParsedAst();
  ...
  public void globalCallExpr_replaceRoot() throws Exception {
    ...
    MutableAst mutableAst = MutableAst.fromCelAst(ast);
    MutableExpr newExpr = MutableExpr.ofConstant(CelConstant.ofValue(10));

    MutableAst result =
        MUTABLE_AST.replaceSubtree(mutableAst, newExpr, mutableAst.mutableExpr().id());
  ...
  public void globalCallExpr_replaceLeaf() throws Exception {
    ...
    MutableAst result =
            MUTABLE_AST.replaceSubtree(mutableAst, newExpr, 1);
  ...
  public void globalCallExpr_replaceMiddleBranch() throws Exception {
    ...
    MutableAst result =
            MUTABLE_AST.replaceSubtree(mutableAst, newExpr, 2);
  ...
  public void globalCallExpr_replaceMiddleBranch_withCallExpr() throws Exception {
    ...
    MutableAst result = MUTABLE_AST.replaceSubtree(mutableAst, newExpr, 2);
  ...
  public void memberCallExpr_replaceLeafTarget() throws Exception {
    ...
    MutableAst mutableAst = MutableAst.fromCelAst(ast);
    MutableExpr newExpr = MutableExpr.ofConstant(CelConstant.ofValue(20));

    MutableAst result = MUTABLE_AST.replaceSubtree(mutableAst, newExpr, 3);
  ...
  public void memberCallExpr_replaceLeafArgument() throws Exception {
    ...
    MutableAst result = MUTABLE_AST.replaceSubtree(mutableAst, newExpr, 5);
  ...
  public void memberCallExpr_replaceMiddleBranchTarget() throws Exception {
    ...
    MutableAst result = MUTABLE_AST.replaceSubtree(mutableAst, newExpr, 1);
  ...
  public void memberCallExpr_replaceMiddleBranchArgument() throws Exception {
    ...
    MutableAst result = MUTABLE_AST.replaceSubtree(mutableAst, newExpr, 4);
  ...
  public void list_replaceElement() throws Exception {
    ...
    MutableAst mutableAst = MutableAst.fromCelAst(ast);
    MutableExpr newExpr = MutableExpr.ofConstant(CelConstant.ofValue(5));
  ...
  public void comprehension_replaceIterRange() throws Exception {
    ...
    MutableAst mutableAst = MutableAst.fromCelAst(ast);
    MutableExpr newExpr = MutableExpr.ofConstant(CelConstant.ofValue(false));
  ...
  public void comprehension_replaceAccuInit() throws Exception {
    ...
    MutableAst mutableAst = MutableAst.fromCelAst(ast);
    MutableExpr newExpr = MutableExpr.ofConstant(CelConstant.ofValue(true));

    CelAbstractSyntaxTree replacedAst = MUTABLE_AST.replaceSubtree(mutableAst, newExpr, 6).toParsedAst();
  ...
  public void replaceSubtree_iterationLimitReached_throws() throws Exception {
    CelAbstractSyntaxTree ast = CEL.compile("true && false").getAst();
    MutableAst mutableAst = MutableAst.fromCelAst(ast);
    AstMutator astMutator = newInstance(1);
        ...
        assertThrows(
            ...
            () ->
                astMutator.replaceSubtree(
                    mutableAst, MutableExpr.ofConstant(CelConstant.ofValue(false)), 1));
