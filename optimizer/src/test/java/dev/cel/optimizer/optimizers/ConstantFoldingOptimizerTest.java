...
public class ConstantFoldingOptimizerTest {
  ...
  @TestParameters("{source: 'duration(\"1h\") - duration(\"60m\")', expected: 'duration(\"0\")'}")
  @TestParameters("{source: 'duration(\"2h23m42s12ms42us92ns\") + duration(\"129481231298125ns\")', expected: 'duration(\"138103.243340217s\")'}")
  @TestParameters("{source: 'timestamp(900000) - timestamp(100)', expected: 'duration(\"899900s\")'}")
  @TestParameters("{source: 'timestamp(\"2000-01-01T00:02:03.2123Z\") + duration(\"25h2m32s42ms53us29ns\")', expected: 'timestamp(\"2000-01-02T01:04:35.254353029Z\")'}")
