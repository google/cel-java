...
public class CelEnvironmentExporterTest {
  ...
  public void standardLibrarySubset_favorExclusion() throws Exception {
    ...
    assertThat(celEnvironment.standardLibrarySubset().get())
        .isEqualTo(
