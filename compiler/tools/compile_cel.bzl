...
def compile_cel(
    ...
    Args:
          ...
          proto_srcs: (optional) str label pointing to a proto_library rule. A proto_library must be provided when compiling a CEL expression containing protobuf messages.
